  ...
  return (
    <Form className="postform" onSubmit={handleSubmit(onSubmit)} >
      ...
      <Form.Group>
        ...
        <Form.Control value={formState.Cause_type} name="Website Link" ref={register({ required: true, minLength: "3" })} onChange={setFormState} className="forminput" type="text" placeholder="" />
        <Form.Text className="text-muted">
