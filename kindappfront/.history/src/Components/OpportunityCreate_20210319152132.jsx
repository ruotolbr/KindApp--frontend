  ...
  return (
    <Form className="postform" onSubmit={handleSubmit(onSubmit)} >
      ...
      <Form.Group>
        ...
        <Form.Control id="id" value={formState.title} name="Title" ref={register({ required: true })} onChange={setFormState} className="forminput" type="text" placeholder="" />
      ...
      <Form.Group>
        ...
        <Form.Control value={formState.Cause_type} name="Website Link" ref={register({ required: true })} onChange={setFormState} className="forminput" type="text" placeholder="" />
        <Form.Text className="text-muted">
      ...
      <Form.Group>
        ...
        <Form.Control value={formState.Organization} name="Website Link" ref={register({ required: true })} onChange={setFormState} className="forminput" type="text" placeholder="" />
        <Form.Text className="text-muted">
