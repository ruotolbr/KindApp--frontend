...
function OpportunityCreate({ opp, setOpp }) {
  ...
  async function getUserData(){
    const userAPI = "https://kindapp-backend.herokuapp.com/posts/"
    try {
    ...
    <Form className="postform" onSubmit={handleSubmit(onSubmit)}>
      ...
      <Form.Group className="form-elements">
        ...
        <Form.Text className="text-muted">
          This is what people will see before clicking your post! <br/>
          {errors.Title && (
        ...
        />
        <Form.Text className="text-muted">
          Ex: covid-19 relief, fight homelessness, climate change etc. <br/>
          {errors.Cause_type && (
        ...
        />
        <Form.Text className="text-muted">
          What organization needs our help? <br/>
          {errors.Cause_type && (
        ...
        />
        <Form.Text className="text-muted">
          Put the url for the original posting here!
        </Form.Text>
        ...
        />
        <Form.Text className="text-muted">
          What is it that they need help with? <br/>
          {errors.Cause_type && (
          <span className="form-error">
      ...
      <Container>
        ...
        <Card style={{ width: "18rem" }} className="adding-margin">
          ...
          <Card.Body>
            ...
            {/* <Link to={`/post/create/${opp.id}`} key={opp.id}> */}
