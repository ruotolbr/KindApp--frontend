...
function OpportunityCreate({ opp, setOpp }) {
  ...
  return (
    <Form className="postform" userInput={handleSubmit(submitNewPost)}>
      <Row>
        <h3 className="formheading">Post a volunteer opportunity!</h3>
      </Row>
      <Form.Group controlId="numone">
        <Form.Label>Title</Form.Label>
        <Form.Control id="id" value={formState.id} onChange={userInput} className="forminput" type="text" placeholder="" />
